...
public class Program {
    ...
    private static void output(Set<Double> x, Set<Double> discrepancy) {
        System.out.println("Start convergence: (" + x0 + ", " + y0 + ")");
    ...
    public static void start() {
        ...
        Set<Double> result = Yakobi.run(function1, function2, x0, y0, eps);

        function1 = new Function(expression1, "x");
        function2 = new Function(expression2, "y");
        Set<Double> discrepancy = Yakobi.calcDiscrepancy(result, function1, function2);
