package com.company.Saska.task3.Frame;
...
import static com.company.Saska.task3.Main.Program.maxX;
import static com.company.Saska.task3.Main.Program.minX;


public class DrawFrame {

    public static void draw(Dot[] dots, double[] y) {
