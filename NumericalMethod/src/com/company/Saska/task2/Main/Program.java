...
import com.company.Saska.task2.Frame.DrawFrame;
import com.company.Saska.task2.methods.LocalSmoothingOfData;
...
public class Program {
    ...
    private void input() throws FileNotFoundException {
        ...
        String path = Path.of("").toAbsolutePath() + "\\resources\\task2\\input2.txt";
